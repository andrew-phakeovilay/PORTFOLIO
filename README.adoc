...
* link:pass:[https://github.com/andrew-phakeovilay/andrew-projet-react][*J'ai développé un site de comparison de prix de jeux videos qui communique avec une API*]
+
DEMO : https://andrew-phakeovilay.github.io/andrew-projet-react/
+
_Recherche de jeux vidéos, 
option favoris, voir les favoris, 
Mode sombre et optimisation de code_
+
(React, Vite, Tailwind, Visual Studio Code, Git)
...
* *J'ai appris à créer une machine virtuelle Ubuntu avec les fonctionnalités principales (des logiciels, personnalisation du terminal)*
+
