			...
			<form method='post' action='ConsultPrix.php'>
				...
				<?php
					...
					IF(isset($_POST['Afficher']) && isset($_POST['BR_Prix'])){
						...
						$result->execute();
						$confirmation = "Êtes-vous sûr de vouloir supprimer ce bien ?";
						echo '
						...
						foreach($result as $value) {
							echo '<tr>';
								...
								echo '<td><a href="ModifBien.php?pIdBien='.$value['idBien'].'"><img src="./images/modifier.jpg"></a></td>';
								echo '<td><a onclick="return confirm(\'Êtes-vous sûr de vouloir supprimer ce bien ?\')" href="SupprimBien.php?pIdBien='.$value['idBien'].'"><img src="./images/supprimer.jpg"></a></td>';
							echo '</tr>';
						}
						echo '</table></center>';
					}
