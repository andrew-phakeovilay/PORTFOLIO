...
import fr.iutblagnac.devmobtp1p2.model.TodoListAdapter;
import fr.iutblagnac.devmobtp1p2.model.TodoListData;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void onCreateContextMenu(ContextMenu menu, View v, ContextMenu.ContextMenuInfo menuInfo) {
        ...
        menu.setHeaderTitle(this.getResources().getString(R.string.main_menu_header));
    ...
    public boolean onContextItemSelected(@NonNull MenuItem item) {
        ...
        if (item.getItemId() == R.id.listview_menu_show_todo_id) {
            Toast.makeText(this,  this.getResources().getString(R.string.menu_show) + ", id : " + info.id + ", todo : " + tlAdapter.getItem(info.position), Toast.LENGTH_SHORT).show();
        }
        if (item.getItemId() == R.id.listview_menu_modify_todo_id) {
            Toast.makeText(this, this.getResources().getString(R.string.menu_edit) + ", id : " + info.id + ", todo : " + tlAdapter.getItem(info.position), Toast.LENGTH_SHORT).show();
        }
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        if (item.getItemId() == R.id.main_menu_ajouter_todo_id) {
            Toast.makeText(this, this.getResources().getString(R.string.main_menu_ajouter_todo_text), Toast.LENGTH_SHORT).show();
            return true;
        }
    ...
    private void deleteAlert(Todo _todo){
        ...
        quitDBuilder.setTitle(this.getResources().getString(R.string.alert_title));
        quitDBuilder.setMessage(this.getResources().getString(R.string.alert_content));
